...
const NotFoundPage = () => {
   return (
      <HeaderFooter title={`Page not found | ${SITE_NAME}`}>
         <div className="lg:ml-[17rem] ml-[5rem] lg:px-42 lg:py-24 md:py-20 md:px-44 px-4 py-24 items-center flex justify-center flex-col-reverse lg:flex-row md:gap-28 gap-16">
