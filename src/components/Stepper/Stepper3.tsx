...
const Stepper = () => {
   return (
      <div className="relative mt-10">
         ...
         <div className="absolute top-0 base-bg-color z-5 w-[100%] rounded-full h-1"></div>
         <div className="absolute -top-5 flex items-center justify-between w-full">
            ...
            <span className="flex items-center justify-center rounded-full base-bg-color h-11 w-11 text-white">2</span>
            <span className="flex items-center justify-center rounded-full base-bg-color h-11 w-11 text-white">3</span>
