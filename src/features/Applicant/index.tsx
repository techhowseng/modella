...
const Applicant = () => {
   ...
   const applicant = recomData.find(item => item.id === applicantId)
         ...
         <div className='w-full max-w-[1000px] sm:w-[90%] bg-white p-10 rounded-2xl'>
            <div className="text-sm text-gray-700 font-bold space-y-6 sm:space-y-8  ">
               <div className='flex items-center gap-x-2'>
                  <div className='h-16 rounded-2xl overflow-hidden'><img className='w-full h-full' src={applicant.img} alt="Aplicants-Image" /></div>
                  <div>
